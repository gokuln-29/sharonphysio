        ...
        <div className="border-t border-navy-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col items-center md:items-start gap-1.5">
            <p className="text-sm text-navy-300 text-center md:text-left">
              © {siteConfig.founded}–2027 Sharon Physiotherapy & Rehabilitation Center. All rights reserved.
            </p>
            <p className="text-sm text-navy-400 text-center md:text-left">
              Designed and developed by <a href="https://neoklyn.com" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 transition-colors">NeoKlyn.com</a>
            </p>
          </div>
