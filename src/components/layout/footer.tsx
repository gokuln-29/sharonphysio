      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <nav className="space-y-3">
              ...
              <Link href="/treatments#joint" className="block text-sm text-navy-200 hover:text-teal-400 transition-colors">
                Joint Replacement
              </Link>
              <Link href="/treatments#parkinson" className="block text-sm text-navy-200 hover:text-teal-400 transition-colors">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="#" className="w-10 h-10 rounded-full bg-navy-800 flex items-center justify-center hover:bg-teal-600 transition-colors" aria-label="Facebook">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-navy-800 flex items-center justify-center hover:bg-teal-600 transition-colors" aria-label="Instagram">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-navy-800 flex items-center justify-center hover:bg-teal-600 transition-colors" aria-label="Twitter">
        ...
        <div className="border-t border-navy-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-navy-300">
            © {new Date().getFullYear()} Sharon Physiotherapy & Rehabilitation Center. All rights reserved.
          </p>
